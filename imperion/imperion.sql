...
CREATE TABLE `tb_inimigo` (
  ...
  `nr_poder` int(11) DEFAULT NULL,
  `nr_diplomacia` int(11) DEFAULT NULL,
  `nr_max_respaw` int(11) DEFAULT NULL,
  `tx_sprite` varchar(100) DEFAULT NULL,
  `nr_alcance` int(11) DEFAULT NULL,
  `nr_velocidade_ataque` int(11) DEFAULT NULL,
  `nr_velocidade` int(11) DEFAULT NULL,
  `nr_agressividade` int(11) DEFAULT NULL,
...
INSERT INTO `tb_inimigo` (`id_inimigo`,`tx_nome`,`nr_nivel`,`nr_exp`,`nr_energia`,`nr_poder`,`nr_diplomacia`,`nr_max_respaw`,`tx_sprite`,`nr_alcance`,`nr_velocidade_ataque`,`nr_velocidade`,`nr_agressividade`,`nr_ouro`) VALUES 
 (1,'Crecken',1,15,300,3,50,20,'monster1',1000,1000,20,200,200),
 (2,'Rainha Crecken',1,75,600,8,100,1,'monster1',5000,800,50,300,2000);
...
INSERT INTO `tb_mina` (`id_mina`,`id_personagem`,`nr_nivel`,`nr_custo_nivel`,`nr_captacao_nivel`,`nr_personagem_nivel`,`dt_acao`,`st_acao`,`nr_ouro`,`nr_cristal`,`nr_plutonio`) VALUES 
 (1,1,2,3000,6,0,'2015-08-12 11:02:34',NULL,200,0,0);
...
CREATE TABLE `tb_personagem` (
  ...
  `nr_cristal` int(11) DEFAULT NULL,
  `nr_exp_base` int(11) DEFAULT NULL,
...
INSERT INTO `tb_personagem` (`id_personagem`,`id_usuario`,`tx_nome`,`nr_nivel`,`nr_exp_atual`,`nr_exp_next`,`nr_energia`,`nr_energia_total`,`nr_combustivel`,`nr_combustivel_total`,`nr_ouro`,`nr_diplomacia`,`nr_tecnologia`,`nr_poder`,`nr_captacao`,`nr_pontos`,`id_especialidade`,`nr_cristal`,`nr_exp_base`) VALUES 
 (1,1,'Atirador',1,0,800,100,100,10,10,400,1,1,4,3,0,2,20,0);
